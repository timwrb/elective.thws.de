<div>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            ...
            <flux:heading size="xl" class="mt-4">Edit Research Project</flux:heading>
        </div>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex justify-end gap-3">
                <flux:button href="{{ route('research-projects.show', $researchProject) }}" variant="ghost">Cancel</flux:button>
