<div>
    <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-700 p-8 text-center">
            ...
            <flux:heading size="xl">You've been invited</flux:heading>
            <flux:subheading class="mt-1 mb-6">Join the research project below</flux:subheading>
            ...
            <div class="text-left bg-zinc-50 dark:bg-zinc-800 rounded-lg p-4 mb-6">
                ...
                <div class="flex flex-wrap gap-2 mt-3">
                    <flux:badge color="blue">{{ $researchProject->credits }} credits</flux:badge>
            ...
            @if($this->isAlreadyMember)
                <flux:callout icon="check-circle" color="green" class="mb-4 text-left">
                    <flux:callout.text>You are already a member of this project.</flux:callout.text>
                </flux:callout>
            ...
            @elseif($this->isEnrolledElsewhere)
                <flux:callout icon="x-circle" color="red" class="mb-4 text-left">
                    <flux:callout.text>You are already enrolled in another research project this semester. You cannot join multiple projects.</flux:callout.text>
                </flux:callout>
            @elseif(!$this->settings->applicationOpen)
                <flux:callout icon="lock-closed" color="zinc" class="mb-4 text-left">
                    <flux:callout.text>Applications are currently closed. You cannot join at this time.</flux:callout.text>
                </flux:callout>
            @else
                <flux:button wire:click="join" variant="primary" class="w-full" wire:loading.attr="disabled">
                    <span wire:loading.remove>Join Project</span>
